...
let cardCount = 0; // used to reset hand display
let DcardCount = 0;
...
function changeImage(cardVal, name) {
    if(cardCount == 0){ //Card count iterates when the program iterates through the array of player hand cards
        var image = document.getElementById('card1'); //this chooses one of the established blank cards based on where the card count says we should be
        choose(image, cardVal, name);
        ...
        var image = document.getElementById('card5');
        choose(image, cardVal, name);

    }
}
function DChangeImage(cardVal, name, d){
    if(d == 0){
        var image = document.getElementById('DCard1');
        choose(image, cardVal, name);

    } else if(d == 1){
        var image = document.getElementById('DCard2');
        choose(image, cardVal, name);

    } else if(d == 2){
        var image = document.getElementById('DCard3');
        choose(image, cardVal, name);
        
    } else if(d == 3){
        var image = document.getElementById('DCard4');
        choose(image, cardVal, name);
        
    } else if(d == 4){
        var image = document.getElementById('DCard5');
        choose(image, cardVal, name);

    }
}

function choose(img, val, name){
    const club = "club";
    const heart = "heart";
    const diamond = "diamon";
    
    //I just thought these effects looked neat
    img.style.boxShadow = "3px 5px 10px gray";
    img.style.opacity = 1;

    switch(val){//The value and suit of the card determine which image we need to display
        case 2: //case of the value for the card determines which number or face card should show
            if(name.includes(club)){ //includes() tells us if the card name fits one of the types
                img.src = "Cards/2c.png";
            }else if(name.includes(heart)){
                img.src = "Cards/2h.png";
        ...
        case 3:
            if(name.includes(club)){
                img.src = "Cards/3c.png";
            }else if(name.includes(heart)){
                img.src = "Cards/3h.png";
            }else if(name.includes(diamond)){
                img.src = "Cards/3d.png";
            } else {
            img.src = "Cards/3s.png";
            }
            break;
        case 4:
            if(name.includes(club)){
                img.src = "Cards/4c.png";
            }else if(name.includes(heart)){
                img.src = "Cards/4h.png";
            }else if(name.includes(diamond)){
                img.src = "Cards/4d.png";
            } else {
            img.src = "Cards/4s.png";
            }
            break;
        case 5:
            if(name.includes(club)){
                img.src = "Cards/5c.png";
            }else if(name.includes(heart)){
                img.src = "Cards/5h.png";
            }else if(name.includes(diamond)){
                img.src = "Cards/5d.png";
            } else {
            img.src = "Cards/5s.png";
            }
            break;
        case 6:
            if(name.includes(club)){
                img.src = "Cards/6c.png";
            }else if(name.includes(heart)){
                img.src = "Cards/6h.png";
            }else if(name.includes(diamond)){
                img.src = "Cards/6d.png";
            } else {
            img.src = "Cards/6s.png";
            }
            break;
        case 7:
            if(name.includes(club)){
                img.src = "Cards/7c.png";
            }else if(name.includes(heart)){
                img.src = "Cards/7h.png";
            }else if(name.includes(diamond)){
                img.src = "Cards/7d.png";
            } else {
            img.src = "Cards/7s.png";
            }
            break;
        case 8:
            if(name.includes(club)){
                img.src = "Cards/8c.png";
            }else if(name.includes(heart)){
                img.src = "Cards/8h.png";
            }else if(name.includes(diamond)){
                img.src = "Cards/8d.png";
            } else {
            img.src = "Cards/8s.png";
            }
            break;
        case 9:
            if(name.includes(club)){
                img.src = "Cards/9c.png";
            }else if(name.includes(heart)){
                img.src = "Cards/9h.png";
            }else if(name.includes(diamond)){
                img.src = "Cards/9d.png";
            } else {
            img.src = "Cards/9s.png";
            }
            break;
        case 10:
            //The value 10 is equal to all face cards so we need to check if the name in the array matches any face cards
            if(name.includes("King")){
                if(name.includes(club)){
                    img.src = "Cards/Kc.png";
                }else if(name.includes(heart)){
                    img.src = "Cards/Kh.png";
                }else if(name.includes(diamond)){
                    img.src = "Cards/Kd.png";
                } else {
                img.src = "Cards/Ks.png";
                }
            } else if(name.includes("Queen")){
                if(name.includes(club)){
                    img.src = "Cards/Qc.png";
                }else if(name.includes(heart)){
                    img.src = "Cards/Qh.png";
                }else if(name.includes(diamond)){
                    img.src = "Cards/Qd.png";
                } else {
                img.src = "Cards/Qs.png";
                }
            } else if(name.includes("Jack")){
                if(name.includes(club)){
                    img.src = "Cards/Jc.png";
                }else if(name.includes(heart)){
                    img.src = "Cards/Jh.png";
                }else if(name.includes(diamond)){
                    img.src = "Cards/Jd.png";
                } else {
                img.src = "Cards/Js.png";
                }
            }else{
                if(name.includes(club)){
                    img.src = "Cards/10c.png";
                }else if(name.includes(heart)){
                    img.src = "Cards/10h.png";
                }else if(name.includes(diamond)){
                    img.src = "Cards/10d.png";
                } else {
                img.src = "Cards/10s.png";
                }
            }
            break;

        default: //ace is a strange card since its value can be 11 or 1 so it is kept as the default to save some space
            if(name.includes(club)){
                img.src = "Cards/Ac.png";
            }else if(name.includes(heart)){
                img.src = "Cards/Ah.png";
            }else if(name.includes(diamond)){
                img.src = "Cards/Ad.png";
            } else {
            img.src = "Cards/Ass.png";
            }
            //no break included because this is the default
        }

}
function minireset(img){
    //img.src= "Cards/blank.png"; //styles and images must be reset to prevent random shadows and outlines hanging out in space
    if (img == document.getElementById('DCard1')){
...
var drawHands = function () {    
    ...
    htmlswap += "<ul>";
    cardCount = 0; //count how many images to change
    for (var i = 0; i < jsbApp.playerHand.length; i++)
    {
        htmlswap += "<li>" + jsbApp.playerHand[i].name + "</li>";
        changeImage(jsbApp.playerHand[i].value, jsbApp.playerHand[i].name); 
        cardCount++;
    }
    htmlswap += "</ul>"
    ...
    for (var i = 0; i < jsbApp.dealerHand.length; i++) {
        ...
        DChangeImage(jsbApp.dealerHand[i].value, jsbApp.dealerHand[i].name, DcardCount);
        DcardCount += 1;
    }
    htmlswap += "</ul>"
...
var victory = function () {
    ...
    jsbApp.textUpdates.innerHTML = "You won! WHOOP!<br>" + explanation + "<br>Press 'New Game' to play again.";
    track();
}
...
var bust = function () {
    ...
    jsbApp.textUpdates.innerHTML = "Ring-a-ding-ding baby.<br>" + explanation + "<br>Press 'New Game' to play again.";
    track();
}
